...
class PDF extends FPDF
{
    ...
    function Header()
    {
        ...
        $this->Cell(100, 12, utf8_decode('LIQUIDACION DE NOMINA'), 1, 1, 'C', 0);
        ...
        $this->Cell(42, 10, 'Pago', 1, 1, 'C', $this->fill);
      //  $this->Ln(2);
      //  $this->Cell(22, 10, 'Pago', 1, 2, 'C', $this->fill);
...
if ($result = mysqli_query($link, $sql)) {
    if (mysqli_num_rows($result) > 0) {
        ...
        while ($row = mysqli_fetch_array($result)) {
            ...
            $pdf->Cell(42, 10, '$' . number_format($row['ValorParafiscales'], 2, '.', ''), 1, 1, 'C', $pdf->fill);
          //  $pdf->Cell(42, 10, '$' . number_format($row['NetoPagado'], 2, '.', ''), 1, 1, 'C', $pdf->fill);
