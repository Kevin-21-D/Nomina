    ...
    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div style="margin-right:150px; margin-left: 120px;" class="section-content">
                                    ...
                                    echo '<a href="Prestamos/create-pres.php" class="btn btn-success">
                                            Agregar
                                        </a>';
                                    }
     ...
     <a href="#" class="download-icon" title="Descargar informe">
                                ...
                                <?php
                                    ...
                                    $sql = "SELECT n.*, u.Nombre, u.Apellido,u.IDrol FROM prestamos n INNER JOIN usuario u ON n.IDusuario = u.IDusuario";
                                    $result = mysqli_query($link, $sql);

                                    if ($result= mysqli_query($link, $sql)) {
                                        if (mysqli_num_rows($result) > 0) {
                                            echo "<table style='margin-left: 25px; width: 700px;' class='table table-bordered table-striped'>";
                                                echo "<thead>";
                                                echo "<tr>";
                                                    echo "<th>#</th>";
                                                    echo "<th>Empleado</th>";
                                                ...
                                                while ($row = mysqli_fetch_array($result)) {
                                                    echo "<tr>";
                                                        ...
                                                        echo "<td>";
                                                         if($_SESSION['tipo']==1 or $_SESSION['tipo']==2  )
                                                         {
                                                            echo "<a href='Prestamos/update-pres.php?id=" . $row['IDpres'] . "' title='Actualizar' data-toggle='tooltip'><span class='glyphicon glyphicon-pencil'></span></a>";
                                                            echo "<a href='Prestamos/delete-pres.php?id=" . $row['IDpres'] . "' title='Borrar' data-toggle='tooltip'><span class='glyphicon glyphicon-trash'></span></a>";
                                                        }
                                                        echo "</td>";
                                                    echo "</tr>";
                                                }
