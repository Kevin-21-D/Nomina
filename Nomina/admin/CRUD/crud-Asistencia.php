    ...
    <div class="container-fluid">
        ...
        <div class="main-content">
            <div class="crud-container">
                <h2 style="padding-left: 163px;" class="col-md-7">Asistencia</h2>
                <div class="wrapper">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-9">
                                <div class="section-content">
                                    ...
                                    <div class="col-md-3">
                                     <?php if($_SESSION['tipo']==1 or $_SESSION['tipo']==2  )
                                       echo '<a href="Asistencia/create-asist.php" class="btn btn-success">
                                       Agregar
                                   </a>';
                                     ?>
                                ...
                                <?php
                                    ...
                                    $sql = "SELECT n.*, u.Nombre, u.Apellido FROM asistencia n 
                                        ...
                                        if (mysqli_num_rows($result) > 0) {
                                            echo "<table style='margin-left: 15px; width: 1000px;' class='table table-bordered table-striped' >";
                                                ...
                                                while ($row = mysqli_fetch_array($result)) {
                                                    echo "<tr>";
                                                        echo "<td>" . $row['IDAsistencia'] . "</td>";
                                                        echo "<td>" . $row['FechayHora'] . "</td>";
                                                        echo "<td>" . $row['Nombre'] . $row['Apellido']."</td>";
                                                        echo "<td>";
                                                        if($_SESSION['tipo']==1 or $_SESSION['tipo']==2  )
                                                        {
                                                            echo "<a href='Asistencia/update-asist.php?id=" . $row['IDparafiscal'] . "' title='Actualizar' data-toggle='tooltip'><span class='glyphicon glyphicon-pencil'></span></a>";
                                                            echo "<a href='Asistencia/delete-asist.php?id=" . $row['IDparafiscal'] . "' title='Borrar' data-toggle='tooltip'><span class='glyphicon glyphicon-trash'></span></a>";
                                                        }
                                                            echo "</td>";
                                                    echo "</tr>";
                                                }
