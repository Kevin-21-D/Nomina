    ...
    <div class="container-fluid">
        ...
        <div class="main-content">
            <div class="crud-container">
                <h2 style="padding-left: 163px;" class="col-md-7">Ciudades</h2>
                <div class="wrapper">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                <div style="margin-right:150px; margin-left: 120px;" class="section-content">
                                    ...
                                    echo '<a href="Ciudades/create-ciu.php" class="btn btn-success">
                                            Agregar
                                        </a>';
                                    }
     ...
     <a href="#" class="download-icon" title="Descargar informe">
                                ...
                                <?php
                                    ...
                                    $sql = "SELECT n.*, u.NombreDep FROM ciudad n INNER JOIN departamento u ON n.IDdep = u.IDdep";
                                    $result = mysqli_query($link, $sql);

                                    if ($result= mysqli_query($link, $sql)) {
                                        if (mysqli_num_rows($result) > 0) {
                                            echo "<table style='margin-left: 15px; width: 900px;' class='table table-bordered table-striped'>";
                                                echo "<thead>";
                                                echo "<tr>";
                                                    echo "<th>#</th>";
                                                ...
                                                while ($row = mysqli_fetch_array($result)) {
                                                    echo "<tr>";
                                                        echo "<td>" . $row['IDciu'] . "</td>";
                                                        echo "<td>" . $row['NombreCiu'] .  "</td>";
                                                     ...
                                                     //   echo "<td>" . $row['Valor_pres'] . "</td>";
                                                      ...
                                                      //  echo "<td>" . $row['EstadoPres'] . "</td>";
                                                        ...
                                                        echo "<td>";
                                                         if($_SESSION['tipo']==1 or $_SESSION['tipo']==2  )
                                                         {
                                                            echo "<a href='Ciudades/update-ciu.php?id=" . $row['IDpres'] . "' title='Actualizar' data-toggle='tooltip'><span class='glyphicon glyphicon-pencil'></span></a>";
                                                            echo "<a href='Ciudades/delete-ciu.php?id=" . $row['IDpres'] . "' title='Borrar' data-toggle='tooltip'><span class='glyphicon glyphicon-trash'></span></a>";
                                                        }
                                                        echo "</td>";
                                                    echo "</tr>";
                                                }
